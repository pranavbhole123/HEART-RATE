...
fig, ax = plt.subplots()
ax.plot(data0['time'], data0['red'], color='red')
ax.plot(data0['time'], data0['green'], color='green')
ax.plot(data0['time'], data0['blue'], color='blue')
ax.set_xlabel('time')
ax.set_ylabel('RGB')
plt.show()
...
fig, ax = plt.subplots()
ax.plot(data['time'], data['red'], color='red')
ax.plot(data['time'], data['green'], color='green')
ax.plot(data['time'], data['blue'], color='blue')
ax.set_xlabel('time')
ax.set_ylabel('RGB')
plt.show()
...
fig, ax = plt.subplots()
#ax.plot(data2['time'], data2['luminance'], color='black')
ax.plot(data2['time'], data2['colour-u'], color='green')
ax.plot(data2['time'], data2['colour-v'], color='magenta')
ax.set_xlabel('time')
ax.set_ylabel('YUV')
plt.show()
